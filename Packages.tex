...
\usepackage[format=hang, font=normalsize, labelfont=it, textfont=it]{caption}  % Layout fuer Bildbeschriftung
...
\usepackage{titlesec} % Paket für die Formatierung der Kapitelüberschriften
